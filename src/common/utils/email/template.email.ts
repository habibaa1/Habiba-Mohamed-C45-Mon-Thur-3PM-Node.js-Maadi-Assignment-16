...
export const emailTemplate = ({ title, code }: { title: string; code: number }) => {
    ...
    <head>
        ...
        <style type="text/css">
            body { background-color: #888DBF; margin: 0px; }
        </style>
    </head>
                ...
                <td>
                    <table border="0" width="100%">
                        <tr>
                            ...
                            <td>
                                <p style="text-align: right;"><a href="http://localhost:4200/#/" target="_blank" style="text-align: right; text-decoration: none;">View In Website</a></p>
                            </td>
                        </tr>
                    </table>
                </td>
